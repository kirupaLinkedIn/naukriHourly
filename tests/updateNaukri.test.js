...
class NaukriPage {
  ...
  naukriHomePage = 'https://www.naukri.com/mnjuser/homepage'
  ...
  async login(username, password) {
    ...
    await this.page
      .locator("//input[contains(@placeholder,'Enter your active Email ID / Username')]")
      .type(username)
...
test.describe('Update Naukri Profile', () => {
  ...
  test('Update Resume Headline', async ({ browser }) => {
    ...
    await page.goto(naukriPage.naukriHomePage)
